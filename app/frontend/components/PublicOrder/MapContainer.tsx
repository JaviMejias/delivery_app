            ...
            {isAddressesOpen && (
              <div className="absolute bottom-full right-0 mb-3 w-64 max-h-[50vh] overflow-y-auto scrollbar-hide bg-slate-900/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl z-[2001] animate-in fade-in slide-in-from-bottom-2 duration-200">
                {customer_addresses.map((addr: any) => (
                  ...
                  >
                    <div className="w-8 h-8 rounded-full bg-primary-500/10 flex items-center justify-center shrink-0 group-hover:bg-primary-500/20 transition-colors">
                      {addr.alias.toLowerCase().includes('casa') ? (
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-primary-400"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                      ) : (
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-primary-400"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
                      )}
                    </div>
