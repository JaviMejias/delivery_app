class Truck < ApplicationRecord
  ...
  scope :search_by_query, ->(query) { left_joins(:driver).where("trucks.plate_number ILIKE :q OR users.first_name ILIKE :q OR users.last_name ILIKE :q", q: "%#{query}%") if query.present? }
