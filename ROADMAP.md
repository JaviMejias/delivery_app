...
- [ ] **Fase 2: Interfaz Móvil PWA para Conductores (Operación en Terreno)** 🔴 *Pendiente*
- [ ] **Fase 3: Panel de Despacho y Monitoreo de Flota en Vivo (Logística)** 🔴 *Pendiente*
- [ ] **Fase 4: Inteligencia de Stock y Conciliación Automatizada (Finanzas)** 🔴 *Pendiente*
...
- [ ] **Integración de Cierre**
  - [ ] Automatizar la generación de la propuesta de `RouteSettlement` al final del día basada en el stock inicial del camión, las ventas móviles cargadas y el stock físico devuelto.
...
- [ ] **Visualización en Mapa**
  - [ ] Integrar librería de mapas (Leaflet / React-Simple-Maps o Mapbox) en el frontend.
  - [ ] Crear markers interactivos para representar a cada camión (`Truck`).
- [ ] **Información de Carga y Estado**
  - [ ] Tooltip o modal emergente al hacer clic en un camión para mostrar el desglose de cilindros llenos y vacíos cargados actualmente.
  - [ ] Estado dinámico del conductor (En ruta, En entrega, En descanso, Sin ruta asignada).
- [ ] **Asignación Rápida**
...
- [ ] **Asistente de Abastecimiento Predictivo**
  ...
  - [ ] Implementar un panel de alertas de quiebre de stock en la sección de Inventarios.
...
*Espacio reservado para registrar decisiones de diseño, cambios en la base de datos o librerías adicionales que se decida instalar en el camino.*
